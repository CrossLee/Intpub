...
function Datepicker() {
	...
	this.dpDiv = bindHover($('<div width="30px" height="30px" id="' + this._mainDivId + '" class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all"></div>'));
}
