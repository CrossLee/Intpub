...
<table width="99%" border="0" align="center"  cellpadding="3" cellspacing="1" class="table_style">
  			...
  			<tr  class="td_title_2">
	  			...
	  			<td><input type="button" value="添加" class="button_class" onclick="javascript:ModulePart.initAddPartsPage(<s:property value='moduleCode'/>);"></td>
  			</tr>
  			</s:iterator>
  		</table>
  		<table align="center" width="99%" border="0" align="center" >
			<tr>
				...
				<s:if test="pageDTO.pageNo==1&&pageDTO.getTotalPages()==1">
					...
					<font color="#999999"> 首页</font>
					<font color="#999999"> 上一页</font>
					<a style="cursor:hand" href="javascript:void()" onclick="ModulePart.queryModules('${pageNo+1}')">下一页</a>
					<a style="cursor:hand" href="javascript:void()" onclick="ModulePart.queryModules('<s:property value="pageDTO.getTotalPages()" />')">尾页</a>
				</s:elseif> <s:elseif test="pageDTO.pageNo==pageDTO.getBottomPageNo()">
					<a style="cursor:hand" href="javascript:void()" onclick="ModulePart.queryModules(1)">首页</a>
					<a style="cursor:hand" href="javascript:void()" onclick="ModulePart.queryModules('${pageNo-1}')">上一页</a>
					<font color="#999999">下一页</font>
					<font color="#999999">尾页</font>
				 ...
				 &nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="跳转" onclick="ModulePart.queryModules($('#pageNoPro').val())"/></td>
			</tr>
		</table>
</body>
</html>
