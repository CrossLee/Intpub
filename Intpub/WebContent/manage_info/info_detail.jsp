...
var DetailInfo = new function(){
	...
	this.upload = function(){
		...
		dataType:"JSON",
		data:"flag=updateByUpload&content="+content+"&title="+title+"&infoId="+infoId+"&status=1&partCode="+$("#code").val(),
		success:function(data){
...
<form name="form1" action="">
  <table width="99%" border="0" align="center"  cellpadding="3" cellspacing="1" class="table_style">
		  ...
		  <tr>
		    ...
		    <s:if test='%{flag=="updateByUpload"}'>
		    		<input class="button_class" type="button" value="保  存"  onclick="DetailInfo.upload()"/>
		    </s:if>
		    <input class="button_class" type="button" value="返  回"  onclick="DetailInfo.goBack(1)"/></td>
		  </tr>
		</table>
