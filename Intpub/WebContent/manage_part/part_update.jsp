...
<html>
  <head>
	...
	<script language="JavaScript">
		...
		var PartUpdate = new function(){
			...
			// login request
			this.initUpdatePage = function(partCode){
				
				$.ajax({
					type:"POST",
					url:"/Intpub/partspace/toDetail.action?selectedPartCode=" + partCode + "&returnType=update",
					dataType:"HTML",
					data:$('#partUpdateListForm').serialize(),
			...
			this.update = function()
			{
				$.ajax({
					type:"POST",
					url:"/Intpub/partspace/updatePartByPartCode.action?pageNo=1",
					dataType:"HTML",
			...
			this.queryParts = function(pageNo){
				$.ajax({
					type:"POST",
					url:"/Intpub/partspace/queryPartsByCondition.action?returnType=updateList&pageNo="+pageNo,
					dataType:"HTML",
					data:$('#partUpdateListForm').serialize(),
					success:function(data){
							$("#partList").html(data);
  ...
  <body>
  	<div id="man_zone">
  	<form action="" id="partUpdateListForm" name="partUpdateListForm" method="post">
  		<table width="99%" border="0" align="center"  cellpadding="3" cellspacing="1" class="table_style">
  			<tr>
  				...
  				<td colspan="2"><input type="button" class="button_class" value="查询" onclick="javascript:PartUpdate.queryParts(1);"/></td>
  			</tr>
  		</table>
  		<div id="partList">
